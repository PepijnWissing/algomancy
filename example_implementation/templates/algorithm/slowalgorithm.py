...
from algomancy.scenarioengine import BaseAlgorithmParameters, ScenarioResult
from algomancy.scenarioengine.basealgorithm import BaseAlgorithm
from algomancy.scenarioengine.basealgorithmparameters import IntegerParameter, BASE_PARAMS_BOUND
