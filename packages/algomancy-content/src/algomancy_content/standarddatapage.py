...
DATA_TABLE_ITEMS_STORE = "standard-data-table-items-store"
DATA_TABLE_ITEMS = "standard-data-table-items"
DATA_TABLE_LAYOUT_STORE = "standard-data-table-layout-store"
DATA_TABLE_LAYOUT = "standard-data-table-layout"
DATA_LAYOUT_FIGURE = "standard-data-layout-figure"
DATA_RAW_VIEW = "standard-raw-data-view"
        ...
        return html.Div(
            [
                ...
                dbc.Accordion(
                    [
                        dbc.AccordionItem(
                            StandardDataPageContentCreator._create_warehouse_layout_table(
                                data.tables["warehouse_layout"], table_page_size
                            ),
                            title="Warehouse Layout Data",
                        ),
                        dbc.AccordionItem(
                            StandardDataPageContentCreator._create_item_data_table(
