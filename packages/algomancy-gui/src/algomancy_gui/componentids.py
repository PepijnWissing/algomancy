...
ADMIN_DELETE_SESSION = "admin-delete-session"
ADMIN_SELECT_SESSION = "admin-select-session"
SESSION_DELETE_MODAL = "session-delete-modal"
SESSION_DELETE_CONFIRM_BUTTON = "session-delete-confirm-button"
SESSION_DELETE_CANCEL_BUTTON = "session-delete-cancel-button"
