...
class PlaceholderHomePageContentCreator:
    ...
    def create_default_elements_showcase():
        ...
        left_controls = [
            dbc.Row([
                dbc.Col(
                    html.Div([
                        ...
                        dbc.Input(type="text", placeholder="Enter text", id="text-input"),
                    ], className="mb-3"),
                    width=6
                ),
                dbc.Col(
                    html.Div([
                        dbc.Label("Password"),
                        dbc.Input(type="password", placeholder="Enter password", id="password-input"),
                    ], className="mb-3"),
                ),
                dbc.Col(
                    html.Div([
                        dbc.Label("Email"),
                        dbc.Input(type="email", placeholder="name@example.com", id="email-input"),
                    ], className="mb-3"),
                    width=6
                ),
                dbc.Col(
                    html.Div([
                        dbc.Label("URL"),
                        dbc.Input(type="url", placeholder="https://example.com", id="url-input"),
                    ], className="mb-3"),
                    width=6
                ),
            ]),
            dbc.Row([
                dbc.Col(
                    ...
                    html.Div([
                        dbc.Label("Search"),
                        dbc.Input(type="search", placeholder="Search...", id="search-input"),
                    ], className="mb-3"),
                    width=6
                ),
                dbc.Col(
                    html.Div([
                        dbc.Label("Number"),
                        dbc.Input(type="number", min=0, max=10, step=1, value=5, id="number-input"),
                    ], className="mb-3"),
                ),
                dbc.Col(
                    ...
                    html.Div([
                        dbc.Label("Range"),
                        dcc.Slider(min=0, max=100, value=50, step=1, marks={0: 0, 25: 25, 50: 50, 75: 75, 100: 100},
                                   id="range-slider"),
                    ], className="mb-4"),
                    width=6
                ),
                dbc.Col(
                    html.Div([
                        ...
                        dcc.DatePickerSingle(id='my-date-picker', date=date(2025, 1, 1)),
                        dcc.DatePickerRange(id='range-datepicker', start_date=date(2025, 1, 1),
        ...
        right_controls = [
            ...
            html.Div([
                dbc.Label("Textarea"),
                dbc.Textarea(placeholder="Enter multi-line text", rows=3, id="textarea-input"),
            ], className="mb-3"),
        ...
        table_component = dbc.Table([
            html.Thead(
                html.Tr([
                    html.Th("Header 1"), html.Th("Header 2"), html.Th("Header 3"),
                ])
            ),
            html.Tbody([
        ...
        media_component = html.Div([
            ...
            html.Img(src="assets/pepsi_girl.jpeg", alt="Placeholder image", style={"maxWidth": "45%"}),
        ])
