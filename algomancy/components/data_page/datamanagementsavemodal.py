...
from algomancy.components.componentids import DM_SAVE_MODAL, DM_SAVE_MODAL_CLOSE_BTN, DM_SAVE_SET_SELECTOR, DM_SAVE_SUBMIT_BUTTON
...
def create_derived_data_selector(sm: ScenarioManager):
    ...
    """
    derived_options = [{"label": ds, "value": ds} for ds in sm.get_data_keys() if not sm.get_data(ds).is_master_data()]
