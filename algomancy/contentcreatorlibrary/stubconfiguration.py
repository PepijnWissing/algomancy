...
from algomancy.contentcreatorlibrary.placeholderalgorithmtemplate import (
    placeholder_algorithm_template,
)
from algomancy.contentcreatorlibrary.placeholderinputconfig import (
    placeholder_input_config,
)
from algomancy.contentcreatorlibrary.placeholderkpitemplate import (
    placeholder_kpi_template,
)
